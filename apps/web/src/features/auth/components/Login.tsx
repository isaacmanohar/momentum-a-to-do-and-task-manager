    ...
    <div className="relative flex min-h-screen items-center justify-center bg-black p-4 font-sans selection:bg-white/30 text-white">
      ...
      <div className="relative w-full max-w-[400px] z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-[28px] font-semibold tracking-tight text-white mb-2">Log in to Momentum</h2>
        ...
        <div className="text-center mt-8">
          <p className="text-[12px] text-[#888]">
            By logging in, you agree to our <a href="#" className="underline hover:text-[#a1a1a1] transition-colors">Terms</a>, <a href="#" className="underline hover:text-[#a1a1a1] transition-colors">Acceptable Use</a>, and <a href="#" className="underline hover:text-[#a1a1a1] transition-colors">Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
