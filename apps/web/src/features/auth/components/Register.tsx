...
export function Register() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#000000] p-4 md:p-8 font-sans selection:bg-white/20 text-white overflow-hidden">
      ...
      <div className="relative w-full max-w-[420px] z-10 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
        <div className="flex flex-col items-center text-center mb-10">
          <div className="w-10 h-10 rounded-[12px] bg-[#090909] border border-[#202020] flex items-center justify-center mb-8 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 12V20H8V12L12 16L16 12V20H20V12L16 8L12 12L8 8L4 12Z" fill="white"/>
            </svg>
          </div>
          
          <h2 className="text-[28px] md:text-[32px] font-bold tracking-[-0.02em] text-white leading-[1.1] mb-3">
            Create an account
          </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8">
          <button type="button" className="flex flex-1 items-center justify-center gap-2.5 rounded-[12px] bg-[#111111] border border-[#292929] px-4 h-[44px] text-[14px] font-medium text-white transition-all duration-200 hover:bg-[#171717] hover:-translate-y-[1px] active:scale-[0.98]">
            <svg viewBox="0 0 24 24" className="h-[16px] w-[16px]" aria-hidden="true"><path fill="currentColor" d="M12.0003 4.75C13.7703 4.75 15.3553 5.36 16.6053 6.54998L20.0303 3.125C17.9502 1.19 15.2353 0 12.0003 0C7.31028 0 3.25527 2.69 1.28027 6.60998L5.27028 9.70498C6.21525 6.86 8.87028 4.75 12.0003 4.75Z"></path><path fill="currentColor" d="M23.49 12.275C23.49 11.49 23.415 10.73 23.3 10H12V14.51H18.47C18.18 15.99 17.34 17.25 16.08 18.1L19.945 21.1C22.2 19.01 23.49 15.92 23.49 12.275Z"></path><path fill="currentColor" d="M5.26498 14.2949C5.02498 13.5699 4.88501 12.7999 4.88501 11.9999C4.88501 11.1999 5.01998 10.4299 5.26498 9.7049L1.275 6.60986C0.46 8.22986 0 10.0599 0 11.9999C0 13.9399 0.46 15.7699 1.28 17.3899L5.26498 14.2949Z"></path><path fill="currentColor" d="M12.0004 24.0001C15.2404 24.0001 17.9654 22.935 19.9454 21.095L16.0804 18.095C15.0054 18.82 13.6204 19.245 12.0004 19.245C8.8704 19.245 6.21537 17.135 5.26538 14.29L1.27539 17.385C3.25539 21.31 7.3104 24.0001 12.0004 24.0001Z"></path></svg>
            Google
          </button>
          <button type="button" className="flex flex-1 items-center justify-center gap-2.5 rounded-[12px] bg-[#111111] border border-[#292929] px-4 h-[44px] text-[14px] font-medium text-white transition-all duration-200 hover:bg-[#171717] hover:-translate-y-[1px] active:scale-[0.98]">
            <Github size={16} />
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1.5">
            <label className="block text-[12px] font-medium text-[#787878] pl-1">Name</label>
            <input
              type="text"
              required
              className="w-full h-[48px] rounded-[12px] border border-[#2b2b2b] bg-[#111111] px-4 text-[14px] text-white placeholder:text-[#666] focus:border-[#666] focus:outline-none focus:ring-1 focus:ring-white/10 transition-all duration-200"
              value={name}
          ...
          <div className="space-y-1.5">
            <label className="block text-[12px] font-medium text-[#787878] pl-1">Email</label>
            <input
              type="email"
              required
              className="w-full h-[48px] rounded-[12px] border border-[#2b2b2b] bg-[#111111] px-4 text-[14px] text-white placeholder:text-[#666] focus:border-[#666] focus:outline-none focus:ring-1 focus:ring-white/10 transition-all duration-200"
          ...
          <div className="space-y-1.5">
            <label className="block text-[12px] font-medium text-[#787878] pl-1">Password</label>
            <div className="relative">
              <input
                type="password"
                required
                className="w-full h-[48px] rounded-[12px] border border-[#2b2b2b] bg-[#111111] px-4 text-[14px] text-white placeholder:text-[#666] focus:border-[#666] focus:outline-none focus:ring-1 focus:ring-white/10 transition-all duration-200 pr-10"
                value={password}
                onChange={(e) => setPassword(e.target.value)}
                placeholder="••••••••••••"
              />
              <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-white/60 hover:text-white transition-colors duration-200">
                <Eye size={16} />
              </button>
            </div>
          </div>
        ...
        <div className="text-center mt-10">
          <p className="text-[11px] text-[#787878] leading-relaxed">
