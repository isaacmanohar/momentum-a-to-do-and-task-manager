    ...
    <div className="relative flex min-h-screen items-center justify-center bg-black p-4 overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-[380px] space-y-8 z-10">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold tracking-tight text-white mb-2">Create a Momentum account</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="block text-xs font-medium text-[#888]">Name</label>
              <input
                type="text"
                required
        ...
        <div className="text-center mt-6">
          <p className="text-[11px] text-[#666]">
            By signing up, you agree to our <a href="#" className="underline hover:text-white transition-colors">Terms</a>, <a href="#" className="underline hover:text-white transition-colors">Acceptable Use</a>, and <a href="#" className="underline hover:text-white transition-colors">Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
